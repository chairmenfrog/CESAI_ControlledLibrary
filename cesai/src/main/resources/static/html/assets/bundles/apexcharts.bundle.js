!function (t, e) {
    ...
    function a(t, e) {
        ...
        }), e && (i = t, s = e, (Object.setPrototypeOf || function (t, e) {
    ...
    var lt = function () {
        ...
        return r(e, [{
            ...
            key: "dropShadow", value: function (t, e) {
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0, s = e.top, a = e.left,
        ...
        return r(e, [{
            ...
            key: "renderPaths", value: function (t) {
                var e, i = t.i, s = t.j, a = t.realIndex, n = t.pathFrom, r = t.pathTo, o = t.stroke, l = t.strokeWidth,
                    h = t.strokeLinecap, c = t.fill, d = t.animationDelay, u = t.initialSpeed, g = t.dataChangeSpeed,
                    f = t.className, p = t.id, x = t.shouldClipToGrid, b = void 0 === x || x, m = t.bindEventsOnPaths,
                    v = void 0 === m || m, y = t.drawShadow, w = void 0 === y || y, k = this.w, A = new I(this.ctx),
                    S = new Y(this.ctx), C = this.w.config.chart.animations.enabled,
                ...
                if (M.attr("id", "".concat(p, "-").concat(i)), M.attr("index", a), b && M.attr({"clip-path": "url(#gridRectMask".concat(k.globals.cuid, ")")}), "none" !== k.config.states.normal.filter.type) A.getDefaultFilter(M, a); else if (k.config.chart.dropShadow.enabled && w && (!k.config.chart.dropShadow.enabledSeries || k.config.chart.dropShadow.enabledSeries && -1 !== k.config.chart.dropShadow.enabledSeries.indexOf(a))) {
                ...
                return !C || k.globals.resized || k.globals.dataChanged ? !k.globals.resized && k.globals.dataChanged || S.showDelayedElements() : S.animatePathsGradually(ot({}, X, {
                    speed: u,
                    delay: d
                })), k.globals.dataChanged && L && z && S.animatePathsGradually(ot({}, X, {speed: g})), M
            }
        }, {
            ...
            key: "pathMouseEnter", value: function (t, e) {
                var i = this.w, s = new I(this.ctx), a = parseInt(t.node.getAttribute("index")),
            ...
            key: "getTextRects", value: function (t, e, i, s) {
                var a = !(4 < arguments.length && void 0 !== arguments[4]) || arguments[4], n = this.w,
                    r = this.drawText({
                        x: -200,
                        y: -200,
                        text: t,
        ...
        return r(e, [{
            ...
            key: "drawXAxisAnnotations", value: function () {
                var i = this, t = this.w, s = this.graphics.group({class: "apexcharts-xaxis-annotations"});
            ...
            key: "drawYAxisAnnotations", value: function () {
                var i = this, t = this.w, s = this.graphics.group({class: "apexcharts-yaxis-annotations"});
            ...
            key: "drawPointAnnotations", value: function () {
                var i = this, t = this.w, s = this.graphics.group({class: "apexcharts-point-annotations"});
            ...
            key: "setOrientations", value: function (t) {
                var l = this, h = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : null, c = this.w;
                t.map(function (t, e) {
        ...
        return r(e, [{
            ...
            key: "formatDate", value: function (t, e) {
                var i = !(2 < arguments.length && void 0 !== arguments[2]) || arguments[2],
                    s = !(3 < arguments.length && void 0 !== arguments[3]) || arguments[3], a = this.w.globals.locale,
                    n = ["\0"].concat(S(a.months)), r = [""].concat(S(a.shortMonths)), o = [""].concat(S(a.days)),
                ...
                var g = i ? t.getUTCHours() : t.getHours(), f = 12 < g ? g - 12 : 0 === g ? 12 : g;
        ...
        return r(e, [{
            ...
            key: "fillPath", value: function (t) {
                ...
                return t.color && (o = t.color), -1 === o.indexOf("rgb") ? c = lt.hexToRgba(o, h) : -1 < o.indexOf("rgba") && (h = "0." + lt.getOpacityFromRGBA(r[this.seriesIndex])), "pattern" === l && (s = this.handlePatternFill(s, o, h, c)), "gradient" === l && (a = this.handleGradientFill(a, o, h, this.seriesIndex)), 0 < n.fill.image.src.length && "image" === l ? t.seriesNumber < n.fill.image.src.length ? (this.clippedImgArea({
                    opacity: h,
            ...
            key: "handleGradientFill", value: function (t, e, i, s) {
                var a, n, r = this.w.config, o = this.opts, l = new ht(this.ctx), h = new lt, c = r.fill.gradient.type,
        ...
        return r(i, [{
            ...
            key: "plotChartMarkers", value: function (t, a, n) {
                var r, o = this, l = this.w, h = a, c = t, d = null, u = new ht(this.ctx);
                if (0 < l.globals.markers.size[a] && (d = u.group({class: "apexcharts-series-markers"})).attr("clip-path", "url(#gridRectMarkerMask".concat(l.globals.cuid, ")")), c.x instanceof Array) for (var e = function (t) {
                    var e = n;
        ...
        return r(e, [{
            key: "draw", value: function (t, e, i) {
                var s = this.w, a = new ht(this.ctx), n = i.realIndex, r = i.pointsPos, o = i.zRatio, l = i.elParent,
            ...
            key: "drawPoint", value: function (t, e, i, s, a, n, r) {
                var o = this.w, l = a, h = new Y(this.ctx), c = new I(this.ctx), d = new dt(this.ctx),
                    u = new ut(this.ctx), g = new ht(this.ctx), f = u.getMarkerConfig("apexcharts-marker", l),
        ...
        return r(e, [{
            key: "dataLabelsCorrection", value: function (t, e, i, s, a, n, r) {
                var o = this.w, l = !1, h = new ht(this.ctx).getTextRects(i, r), c = h.width, d = h.height;
            ...
            key: "drawDataLabel", value: function (t, e, i) {
                var s = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : "top", a = this.w,
                    n = new ht(this.ctx), r = a.config.dataLabels, o = 0, l = 0, h = i, c = null;
                ...
                for (var d = 0; d < t.x.length; d++) if (o = t.x[d] + r.offsetX, l = t.y[d] + r.offsetY - a.globals.markers.size[e] - 5, "bottom" === s && (l = l + 2 * a.globals.markers.size[e] + 1.4 * parseInt(r.style.fontSize)), !isNaN(o)) {
                    ...
                    "bubble" === a.config.chart.type ? (g = a.globals.seriesZ[e][h], l = t.y[d] + a.config.dataLabels.offsetY, l = new f(this.ctx).centerTextInBubble(l, e, h).y) : null != u && (g = a.config.dataLabels.formatter(u, {
                        ctx: this.ctx,
                        seriesIndex: e,
                        dataPointIndex: h,
                        w: a
            ...
            key: "plotDataLabelsText", value: function (t) {
                var e = this.w, i = new ht(this.ctx), s = t.x, a = t.y, n = t.i, r = t.j, o = t.text, l = t.textAnchor,
        ...
        return r(s, [{
            key: "draw", value: function (t, e) {
                ...
                for (var r = 0, o = 0; r < t.length; r++, o++) {
                    var l, h, c, d, u = void 0, g = void 0, f = void 0, p = void 0, x = [], b = [],
                        m = i.globals.comboCharts ? e[r] : r, v = s.group({
            ...
            key: "getPathFillColor", value: function (e, i, s, t) {
                var a = this.w, n = new dt(this.ctx), r = null, o = this.barOptions.distributed ? s : i;
            ...
            key: "renderSeries", value: function (t) {
                var e = t.realIndex, i = t.pathFill, s = t.lineFill, a = t.j, n = t.i, r = t.pathFrom, o = t.pathTo,
                    l = t.strokeWidth, h = t.elSeries, c = t.x, d = t.y, u = t.series, g = t.barHeight, f = t.barWidth,
                    p = t.elDataLabelsWrap, x = t.visibleSeries, b = t.type, m = this.w, v = new ht(this.ctx);
            ...
            key: "initVariables", value: function (t) {
                ...
                for (var i = 0; i < t.length; i++) if (0 < t[i].length && (this.seriesLen = this.seriesLen + 1, this.totalItems += t[i].length), e.globals.isXNumeric) for (var s = 0; s < t[i].length; s++) e.globals.seriesX[i][s] > e.globals.minX && e.globals.seriesX[i][s] < e.globals.maxX && this.visibleItems++; else this.visibleItems = e.globals.dataPoints;
            ...
            key: "drawBarPaths", value: function (t) {
                var e = t.indexes, i = t.barHeight, s = t.strokeWidth, a = t.pathTo, n = t.pathFrom, r = t.zeroW,
                    o = t.x, l = t.y, h = t.yDivision, c = t.elSeries, d = this.w, u = new ht(this.ctx), g = e.i,
                    f = e.j, p = e.realIndex, x = e.bc;
            ...
            key: "drawColumnPaths", value: function (t) {
                var e = t.indexes, i = t.x, s = t.y, a = t.xDivision, n = t.pathTo, r = t.pathFrom, o = t.barWidth,
                    l = t.zeroH, h = t.strokeWidth, c = t.elSeries, d = this.w, u = new ht(this.ctx), g = e.i, f = e.j,
            ...
            key: "calculateDataLabelsPos", value: function (t) {
                var e = t.x, i = t.y, s = t.i, a = t.j, n = t.realIndex, r = t.series, o = t.barHeight, l = t.barWidth,
                    h = t.visibleSeries, c = t.renderedPath, d = this.w, u = new ht(this.ctx),
                    g = Array.isArray(this.strokeWidth) ? this.strokeWidth[n] : this.strokeWidth,
                    f = e + parseFloat(l * h), p = i + parseFloat(o * h);
                d.globals.isXNumeric && !d.globals.isBarHorizontal && (f = e + parseFloat(l * (h + 1)) - g, p = i + parseFloat(o * (h + 1)) - g);
                var x, b = e, m = i, v = d.config.dataLabels, y = this.barOptions.dataLabels, w = v.offsetX,
                    k = v.offsetY, A = {width: 0, height: 0};
            ...
            key: "drawCalculatedDataLabels", value: function (t) {
                var e = t.x, i = t.y, s = t.val, a = t.i, n = t.j, r = t.textRects, o = t.barHeight, l = t.barWidth,
                    h = t.dataLabelsConfig, c = this.w, d = new gt(this.ctx), u = new ht(this.ctx), g = h.formatter,
        ...
        return a(e, P), r(e, [{
            key: "draw", value: function (t, e) {
                ...
                for (var n = this.graphics.group({class: "apexcharts-bar-series apexcharts-plot-series"}), r = 0, o = 0, l = 0, h = 0; l < t.length; l++, h++) {
                    var c = void 0, d = void 0, u = void 0, g = void 0, f = void 0, p = void 0, x = [], b = [],
                    ...
                    var v = this.graphics.group({
                            ...
                            rel: l + 1,
                            "data:realIndex": m
                        }), y = this.graphics.group({class: "apexcharts-datalabels"}), w = 0, k = 0, A = 0,
        ...
        return a(e, P), r(e, [{
            key: "draw", value: function (t, e) {
                ...
                for (var r = s.group({class: "apexcharts-candlestick-series apexcharts-plot-series"}), o = 0, l = 0; o < t.length; o++, l++) {
                    var h, c, d = void 0, u = void 0, g = void 0, f = void 0, p = [], x = [],
                        b = i.globals.comboCharts ? e[o] : o, m = s.group({
            ...
            key: "drawCandleStickPaths", value: function (t) {
                var e = t.indexes, i = t.x, s = (t.y, t.xDivision), a = t.pathTo, n = t.pathFrom, r = t.barWidth,
                    o = t.zeroH, l = t.strokeWidth, h = this.w, c = new ht(this.ctx), d = e.i, u = e.j, g = !0,
                    f = h.config.plotOptions.candlestick.colors.upward,
                    p = h.config.plotOptions.candlestick.colors.downward, x = this.yRatio[this.yaxisIndex],
                    b = e.realIndex, m = this.getOHLCValue(b, u), v = o, y = o;
                m.o > m.c && (g = !1);
        ...
        return r(e, [{
            key: "drawXCrosshairs", value: function () {
                var t = this.w, e = new ht(this.ctx), i = new I(this.ctx), s = t.config.xaxis.crosshairs.fill.gradient,
                    a = t.config.xaxis.crosshairs.dropShadow, n = t.config.xaxis.crosshairs.fill.type, r = s.colorFrom,
                    o = s.colorTo, l = s.opacityFrom, h = s.opacityTo, c = s.stops, d = a.enabled, u = a.left,
                    g = a.top, f = a.blur, p = a.color, x = a.opacity, b = t.config.xaxis.crosshairs.fill.color;
        ...
        return r(i, [{
            key: "draw", value: function (t) {
                var e = this.w, i = new ht(this.ctx), s = i.group({class: "apexcharts-heatmap"});
            ...
            key: "determineHeatColor", value: function (t, e) {
                var i = this.w, s = i.globals.series[t][e], a = i.config.plotOptions.heatmap,
                    ...
                    o = Math.min.apply(Math, S(i.globals.series[t])), l = Math.max.apply(Math, S(i.globals.series[t]));
            ...
            key: "calculateHeatmapDataLabels", value: function (t) {
                var e = t.x, i = t.y, s = t.i, a = t.j, n = (t.series, t.rectHeight), r = t.rectWidth, o = this.w,
                    l = o.config.dataLabels, h = new ht(this.ctx), c = new gt(this.ctx), d = l.formatter, u = null;
                if (l.enabled) {
            ...
            key: "animateHeatMap", value: function (t, e, i, s, a, n) {
                var r = this;
                new Y(this.ctx).animateRect(t, {x: e + s / 2, y: i + a / 2, width: 0, height: 0}, {
                    x: e,
                    y: i,
                    width: s,
                    height: a
        ...
        return r(c, [{
            key: "draw", value: function (t) {
                ...
                var f = e.config.plotOptions.pie.customScale, p = e.globals.gridWidth / 2, x = e.globals.gridHeight / 2,
                    b = p - e.globals.gridWidth / 2 * f, m = x - e.globals.gridHeight / 2 * f;
                ...
                return this.sliceLabels.forEach(function (t) {
                    w.add(t)
                }), o.attr({transform: "translate(".concat(b, ", ").concat(m - 5, ") scale(").concat(f, ")")}), s.attr({
            ...
            key: "drawArcs", value: function (t, e) {
                var i = this.w, s = new I(this.ctx), a = new ht(this.ctx), n = new dt(this.ctx), r = a.group(), o = 0,
                    l = 0, h = 0, c = 0;
                ...
                for (var d = 0; d < t.length; d++) {
                    ...
                    var g = h - o, f = n.fillPath({seriesNumber: d, size: this.size, value: e[d]}),
            ...
            key: "animateArc", value: function (e, i, s, a, n, r) {
                ...
                t.globals.dataChanged && r.shouldSetPrevPaths && (o = l.getPiePath({
                    ...
                    angle: n,
                    size: h
                }), e.attr({d: o})), 0 !== r.dur ? e.animate(r.dur, t.globals.easing, r.animBeginArr[r.i]).afterAll(function () {
                    ...
                    angle: a,
                    size: h
                }), r.isTrack || (t.globals.animationEnded = !0), e.node.setAttribute("data:pathOrig", o), e.attr({d: o}))
            }
        }, {
            ...
            key: "getPiePath", value: function (t) {
                ...
                var h = Math.PI * (l - 90) / 180, c = e.centerX + a * Math.cos(o), d = e.centerY + a * Math.sin(o),
                    u = e.centerX + a * Math.cos(h), g = e.centerY + a * Math.sin(h),
                    f = lt.polarToCartesian(e.centerX, e.centerY, e.donutSize, l),
                    p = lt.polarToCartesian(e.centerX, e.centerY, e.donutSize, r), x = 180 < s ? 1 : 0;
            ...
            key: "revertDataLabelsInner", value: function (t, e, i) {
                var s = this, a = this.w, n = a.globals.dom.baseEl.querySelector(".apexcharts-datalabels-group");
                if (e.total.show && 1 < a.globals.series.length) new c(this.ctx).printInnerLabels(e, e.total.label, e.total.formatter(a)); else {
                    ...
                    }), !o) if (a.globals.selectedDataPoints.length && 1 < a.globals.series.length) if (0 < a.globals.selectedDataPoints[0].length) {
                    ...
                    } else n && a.globals.selectedDataPoints.length && 0 === a.globals.selectedDataPoints[0].length && (n.style.opacity = 0); else n && 1 < a.globals.series.length && (n.style.opacity = 0)
                }
            }
        }]), c
    }(), L = function () {
        function a(t) {
            ...
            })[0], s = this.graphics.getTextRects(i, e.config.dataLabels.style.fontSize);
        ...
        return r(a, [{
            key: "draw", value: function (t) {
                ...
                var e = g.globals.gridWidth / 2, i = g.globals.gridHeight / 2, s = this.graphics.group({
                ...
                if (this.yaxisLabels = this.graphics.group({class: "apexcharts-yaxis"}), t.forEach(function (t, n) {
                    ...
                    b = u.graphics.group({class: "apexcharts-series-markers-wrap hidden"}), g.globals.delayedElements.push({
                        el: b.node,
                        index: n
                    });
                    var i = {
                    ...
                    for (var a = 0; a < e.linePathsTo.length; a++) {
                        ...
                        r.add(o);
                        var l = f.fillPath({seriesNumber: n}), h = u.graphics.renderPaths(ot({}, i, {
            ...
            key: "drawLabels", value: function () {
                var n = this, r = this.w, o = "middle", l = r.config.dataLabels,
                    h = this.graphics.group({class: "apexcharts-datalabels"}), c = this.getPolygonPos(this.size), d = 0,
                    u = 0;
            ...
            key: "createPaths", value: function (i, t) {
                ...
                if (i.length) {
                    ...
                    var o = this.graphics.move(i[0].x, i[0].y), l = this.graphics.move(i[0].x, i[0].y);
        ...
        return a(s, T), r(s, [{
            key: "draw", value: function (t) {
                var e = this.w, i = new ht(this.ctx), s = i.group({class: "apexcharts-radialbar"}), a = i.group(),
            ...
            key: "drawTracks", value: function (t) {
                var e = this.w, i = new ht(this.ctx), s = i.group(), a = new I(this.ctx), n = new dt(this.ctx),
            ...
            key: "drawArcs", value: function (t) {
                var e = this.w, i = new ht(this.ctx), s = new dt(this.ctx), a = new I(this.ctx), n = i.group(),
                    r = this.getStrokeWidth(t);
                t.size = t.size - r / 2;
                ...
                for (var x = p ? t.series.length - 1 : 0; p ? 0 <= x : x < t.series.length; p ? x-- : x++) {
                    ...
                    var m = s.fillPath({seriesNumber: x, size: t.size, value: t.series[x]}), v = this.startAngle,
                        y = void 0,
            ...
            key: "drawHollowImage", value: function (e, t, i, s) {
                var a = this.w, n = new dt(this.ctx), r = (Math.random() + 1).toString(36).substring(4),
        ...
        return a(e, P), r(e, [{
            key: "draw", value: function (t, e) {
                ...
                for (var n = s.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), r = 0, o = 0; r < t.length; r++, o++) {
                    ...
                    for (var S = s.group({class: "apexcharts-datalabels"}), C = 0, L = i.globals.dataPoints; C < i.globals.dataPoints; C++, L--) {
                        ...
                        var P = a.fillPath({seriesNumber: m}), E = i.globals.stroke.colors[m];
                        v = this.renderSeries({
                            realIndex: m,
                            pathFill: P,
                            lineFill: E,
            ...
            key: "drawRangeColumnPaths", value: function (t) {
                var e = t.indexes, i = t.x, s = (t.y, t.strokeWidth), a = t.xDivision, n = t.pathTo, r = t.pathFrom,
                    o = t.barWidth, l = t.zeroH, h = this.w, c = new ht(this.ctx), d = e.i, u = e.j,
                    g = this.yRatio[this.yaxisIndex], f = e.realIndex, p = this.getRangeValue(f, u),
                    x = Math.min(p.start, p.end), b = Math.max(p.start, p.end);
            ...
            key: "drawRangeBarPaths", value: function (t) {
                var e = t.indexes, i = (t.x, t.y), s = t.yDivision, a = t.pathTo, n = t.pathFrom, r = t.barHeight,
                    o = t.zeroW, l = this.w, h = new ht(this.ctx), c = e.i, d = e.j, u = e.realIndex, g = o, f = o;
        ...
        function s(t, e, i) {
            n(this, s), this.ctx = t, this.w = t.w, this.xyRatios = e, this.pointsChart = !("bubble" !== this.w.config.chart.type && "scatter" !== this.w.config.chart.type) || i, this.scatter = new f(this.ctx), this.noNegatives = this.w.globals.minX === Number.MAX_VALUE, this.yaxisIndex = 0
        }
        ...
        return r(s, [{
            key: "draw", value: function (t, e, i) {
                ...
                for (var c = this.xyRatios.zRatio, d = this.xyRatios.xRatio, u = this.xyRatios.baseLineY, g = [], f = [], p = 0, x = 0; x < t.length; x++) {
                    ...
                    if (O = this.determineFirstPrevY({
                        ...
                        for (var W = 0; W < t[x].length; W++) if (null !== t[x][W]) {
                    ...
                    for (var V = 1 < s.globals.dataPoints ? s.globals.dataPoints - 1 : s.globals.dataPoints, G = 0; G < V; G++) {
                        ...
                        s.config.chart.stacked ? (H = 0 < x && s.globals.collapsedSeries.length < s.config.series.length - 1 ? f[x - 1][G + 1] : k, C = void 0 === t[x][G + 1] || null === t[x][G + 1] ? H - j / h[this.yaxisIndex] + 2 * (this.isReversed ? j / h[this.yaxisIndex] : 0) : H - t[x][G + 1] / h[this.yaxisIndex] + 2 * (this.isReversed ? t[x][G + 1] / h[this.yaxisIndex] : 0)) : C = void 0 === t[x][G + 1] || null === t[x][G + 1] ? k - j / h[this.yaxisIndex] + 2 * (this.isReversed ? j / h[this.yaxisIndex] : 0) : k - t[x][G + 1] / h[this.yaxisIndex] + 2 * (this.isReversed ? t[x][G + 1] / h[this.yaxisIndex] : 0), w.push(S), y.push(C);
                    ...
                    if ("area" === r) for (var tt = n.fillPath({seriesNumber: v}), et = 0; et < T.length; et++) {
            ...
            key: "createPaths", value: function (t) {
                var e = t.series, i = t.i, s = t.j, a = t.x, n = t.y, r = t.pX, o = t.pY, l = t.xDivision,
                    ...
                    f = t.seriesIndex, p = this.w, x = new ht(this.ctx), b = p.config.stroke.curve;
            ...
            key: "calculatePoints", value: function (t) {
                var e = t.series, i = t.realIndex, s = t.x, a = t.y, n = t.i, r = t.j, o = t.prevY,
                    l = t.categoryAxisCorrection, h = t.xRatio, c = this.w, d = [], u = [];
                if (0 === r) {
            ...
            key: "determineFirstPrevY", value: function (t) {
                ...
                if (void 0 !== i[e][0]) n = l.config.chart.stacked ? (o = 0 < e ? r[e - 1][0] : a) - i[e][0] / s + 2 * (this.isReversed ? i[e][0] / s : 0) : a - i[e][0] / s + 2 * (this.isReversed ? i[e][0] / s : 0); else if (l.config.chart.stacked && 0 < e && void 0 === i[e][0]) for (var h = e - 1; 0 <= h; h--) if (null !== i[h][0] && void 0 !== i[h][0]) {
                    n = o = r[h][0];
                    break
                }
        ...
        return r(e, [{
            key: "getLabel", value: function (t, e, i, s) {
                var a, n = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : [], r = this.w,
                    o = void 0 === t[s] ? "" : t[s], l = r.globals.xLabelFormatter, h = r.config.xaxis.labels.formatter;
                return a = new b(this.ctx).xLabelFormat(l, o), void 0 !== h && (a = h(o, t[s], s)), 0 < e.length ? (i = e[s].position, a = e[s].value) : "datetime" === r.config.xaxis.type && void 0 === h && (a = ""), void 0 === a && (a = ""), (0 === (a = a.toString()).indexOf("NaN") || 0 === a.toLowerCase().indexOf("invalid") || 0 <= a.toLowerCase().indexOf("infinity") || 0 <= n.indexOf(a) && !r.config.xaxis.labels.showDuplicates) && (a = ""), {
                    x: i,
                    text: a
                }
            }
        ...
        return r(i, [{
            ...
            key: "getXAxisTicksPositions", value: function () {
                ...
                if (0 < t.globals.timelineLabels.length) for (var a = 0; a < i; a++) s = this.xaxisLabels[a].position, e.push(s); else for (var n = i, r = 0; r < n; r++) {
                    var o = n;
        ...
        function i(t) {
            n(this, i), this.ctx = t, this.w = t.w;
            var e = this.w;
            this.xaxisFontSize = e.config.xaxis.labels.style.fontSize, this.axisFontFamily = e.config.xaxis.labels.style.fontFamily, this.xaxisForeColors = e.config.xaxis.labels.style.colors, this.xAxisoffX = 0, "bottom" === e.config.xaxis.position && (this.xAxisoffX = e.globals.gridHeight), this.drawnLabels = [], this.axesUtils = new m(t)
        }

        return r(i, [{
            key: "drawYaxis", value: function (t) {
                var e = this.w, i = new ht(this.ctx), s = e.config.yaxis[t].labels.style.fontSize,
                ...
                if (e.config.yaxis[t] && e.config.yaxis[t].reversed && d.reverse(), e.config.yaxis[t].labels.show) for (var u = o; 0 <= u; u--) {
                    var g = d[u];
                    g = c(g, u);
            ...
            key: "drawYaxisInversed", value: function (t) {
                var e = this.w, i = new ht(this.ctx),
                    s = i.group({class: "apexcharts-xaxis apexcharts-yaxis-inversed"}), a = i.group({
                        class: "apexcharts-xaxis-texts-g",
                        transform: "translate(".concat(e.globals.translateXAxisX, ", ").concat(e.globals.translateXAxisY, ")")
                    });
                s.add(a);
                ...
                var d = c.length;
                if (e.config.xaxis.labels.show) for (var u = d ? 0 : n; d ? u < d - 1 : 0 <= u; d ? u++ : u--) {
                    var g = h[u];
                    g = l(g, u);
                ...
                if (void 0 !== e.config.xaxis.title.text) {
                    var m = i.group({class: "apexcharts-xaxis-title apexcharts-yaxis-title-inversed"}), v = i.drawText({
            ...
            key: "yAxisTitleRotate", value: function (t, e) {
                var i = this.w, s = new ht(this.ctx), a = {width: 0, height: 0}, n = {width: 0, height: 0},
            ...
            key: "setYAxisTextAlignments", value: function () {
                var r = this.w, t = r.globals.dom.baseEl.querySelectorAll(".apexcharts-yaxis");
        ...
        return r(e, [{
            key: "niceScale", value: function (t, e) {
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
                    s = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : 10, a = this.w,
            ...
            key: "linearScale", value: function (t, e) {
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 10, s = Math.abs(e - t) / i;
            ...
            key: "setMultipleYScales", value: function () {
                var n = this, r = this.w.globals, o = this.w.config, l = r.minYArr.concat([]), h = r.maxYArr.concat([]),
                    c = [];
        ...
        return r(e, [{
            ...
            key: "getMinYMaxY", value: function (t) {
                var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : Number.MAX_VALUE,
                    ...
                    s = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : null, a = this.w.globals,
            ...
            key: "setYRange", value: function () {
                ...
                if (i.isMultipleYAxis) for (var s = 0; s < i.series.length; s++) {
                ...
                if (i.minY = n.minY, i.maxY = n.maxY, e = n.lowestY, t.chart.stacked) {
                    for (var r = [], o = [], l = 0; l < i.series[i.maxValsInArrayIndex].length; l++) for (var h = 0, c = 0, d = 0; d < i.series.length; d++) null !== i.series[d][l] && lt.isNumber(i.series[d][l]) && (0 < i.series[d][l] ? h = h + parseFloat(i.series[d][l]) + 1e-4 : c += parseFloat(i.series[d][l])), d === i.series.length - 1 && (r.push(h), o.push(c));
            ...
            key: "setXRange", value: function () {
                ...
                if (a.isXNumeric) for (var s = 0; s < a.series.length; s++) if (a.labels[s]) for (var n = 0; n < a.labels[s].length; n++) null !== a.labels[s][n] && lt.isNumber(a.labels[s][n]) && (a.maxX = Math.max(a.maxX, a.labels[s][n]), a.initialmaxX = Math.max(a.maxX, a.labels[s][n]), a.minX = Math.min(a.minX, a.labels[s][n]), a.initialminX = Math.min(a.minX, a.labels[s][n]));
            ...
            key: "setZRange", value: function () {
                ...
                if (t.isDataXYZ) for (var e = 0; e < t.series.length; e++) if (void 0 !== t.seriesZ[e]) for (var i = 0; i < t.seriesZ[e].length; i++) null !== t.seriesZ[e][i] && lt.isNumber(t.seriesZ[e][i]) && (t.maxZ = Math.max(t.maxZ, t.seriesZ[e][i]), t.minZ = Math.min(t.minZ, t.seriesZ[e][i]))
            }
        }]), e
    }(), R = function () {
        function e(t) {
        ...
        return r(e, [{
            ...
            key: "getActiveSeriesIndex", value: function () {
                var i = this.w, t = 0;
                if (1 < i.globals.series.length) for (var e = i.globals.series.map(function (t, e) {
                    return 0 < t.length && "bar" !== i.config.series[e].type && "column" !== i.config.series[e].type ? e : -1
                }), s = 0; s < e.length; s++) if (-1 !== e[s]) {
                    t = e[s];
                    break
                }
                return t
            ...
            key: "getActiveConfigSeriesIndex", value: function () {
                var t = this.w, e = 0;
                if (1 < t.config.series.length) for (var i = t.config.series.map(function (t, e) {
            ...
            key: "getPreviousPaths", value: function () {
                ...
                if (0 < u.length) for (var g = 0; g < u.length; g++) {
                ...
                if (0 < b.length) for (var m = 0; m < b.length; m++) {
                ...
                if (0 < k.length) for (var A = 0; A < k.length; A++) {
            ...
            key: "handleNoData", value: function () {
                var t = this.w, e = t.config.noData, i = new ht(this.ctx), s = t.globals.svgWidth / 2,
        ...
        return r(e, [{
            ...
            key: "setGridCoordsForAxisCharts", value: function (t) {
                var i = this.w, e = i.globals, s = this.getyAxisLabelsCoords(), a = this.getxAxisLabelsCoords(),
                ...
                i.globals.yLabelsCoords = [], i.globals.yTitleCoords = [], i.config.yaxis.map(function (t, e) {
                    i.globals.yLabelsCoords.push({
                        width: s[e].width,
                        index: e
                    }), i.globals.yTitleCoords.push({width: n[e].width, index: e})
            ...
            key: "getxAxisLabelsCoords", value: function () {
                ...
                if (0 < e.globals.timelineLabels.length) {
                    ...
                    e.globals.isBarHorizontal && (r = e.globals.yAxisScale[0].result.reduce(function (t, e) {
                        return t.length > e.length ? t : e
                    }, 0)), r = new b(this.ctx).xLabelFormat(n, r);
                    var o = new ht(this.ctx), l = o.getTextRects(r, e.config.xaxis.labels.style.fontSize);
                    (t = {
                        width: l.width,
                        height: l.height
            ...
            key: "getyAxisLabelsCoords", value: function () {
                ...
                return r.config.yaxis.map(function (t, e) {
                    if (t.show && t.labels.show && r.globals.yAxisScale[e].result.length) {
                        var i = r.globals.yLabelFormatters[e], s = i(r.globals.yAxisScale[e].niceMax, -1);
        ...
        return r(e, [{
            key: "calculateTimeScaleTicks", value: function (t, e) {
                ...
                var a = i.getTimeUnitsfromTimestamp(t, e), n = o.globals.gridWidth / s, l = n / 24, h = l / 60,
                    c = Math.floor(24 * s), d = Math.floor(24 * s * 60), u = Math.floor(s), g = Math.floor(s / 30),
                    f = Math.floor(s / 365), p = {
                ...
                var b = this.timeScaleArray.map(function (t) {
                    ...
                    return "month" === t.unit ? ot({}, e, {value: t.value + 1}) : "day" === t.unit || "hour" === t.unit ? ot({}, e, {value: t.value}) : "minute" === t.unit ? ot({}, e, {
                        value: t.value,
                        minute: t.value
                    }) : t
                });
            ...
            key: "generateYearScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, s = t.currentYear, a = t.daysWidthOnXAxis, n = t.numberOfYears,
                    r = e.minYear, o = 0, l = new k(this.ctx);
            ...
            key: "generateMonthScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonthDate, s = t.currentMonth, a = t.currentYear,
                    n = t.daysWidthOnXAxis, r = t.numberOfMonths, o = s, l = 0, h = new k(this.ctx), c = "month", d = 0;
                if (1 < e.minDate) {
            ...
            key: "generateDayScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, s = t.currentYear, a = t.hoursWidthOnXAxis, n = t.numberOfDays,
                    r = new k(this.ctx), o = "day", l = (24 - e.minHour) * a, h = e.minDate + 1, c = h,
                    d = function (t, e, i) {
            ...
            key: "generateHourScale", value: function (t) {
                var e = t.firstVal, i = t.currentDate, s = t.currentMonth, a = t.currentYear, n = t.minutesWidthOnXAxis,
                    r = t.numberOfHours, o = new k(this.ctx), l = "hour", h = function (t, e) {
            ...
            key: "generateMinuteScale", value: function (t) {
                var e = t.firstVal, i = t.currentMinute, s = t.currentHour, a = t.currentDate, n = t.currentMonth,
                    ...
                    c = e.minMinute + 1, d = c + 1, u = a, g = n, f = r, p = s;
                this.timeScaleArray.push({
                    position: h,
                    value: c,
                    unit: "minute",
            ...
            key: "formatDates", value: function (t) {
                var o = this, l = this.w;
                return t.map(function (t) {
                    var e = t.value.toString(), i = new k(o.ctx), s = o.createRawDateString(t, e),
        ...
        return r(i, [{
            ...
            key: "plotChartType", value: function (i, t) {
                var s = this.w, e = s.config, a = s.globals, n = {series: [], i: []}, r = {series: [], i: []},
                ...
                var c = new M(this.ctx, t), d = new A(this.ctx, t), u = new T(this.ctx), g = new z(this.ctx),
                    f = new E(this.ctx, t), p = new L(this.ctx), x = [];
                if (a.comboCharts) {
                    if (0 < r.series.length && x.push(c.draw(r.series, "area", r.i)), 0 < l.series.length) if (s.config.chart.stacked) {
            ...
            key: "setSVGDimensions", value: function () {
                ...
                var i = lt.getDimensions(this.el), s = e.chart.width.toString().split(/[0-9]+/g).pop();
                if ("%" === s ? lt.isNumber(i[0]) && (0 === i[0].width && (i = lt.getDimensions(this.el.parentNode)), t.svgWidth = i[0] * parseInt(e.chart.width) / 100) : "px" !== s && "" !== s || (t.svgWidth = parseInt(e.chart.width)), "auto" !== t.svgHeight && "" !== t.svgHeight) if ("%" === e.chart.height.toString().split(/[0-9]+/g).pop()) {
            ...
            key: "handleFormat2DArray", value: function (t, e) {
                for (var i = this.w.config, s = this.w.globals, a = 0; a < t[e].data.length; a++) if (void 0 !== t[e].data[a][1] && (Array.isArray(t[e].data[a][1]) && 4 === t[e].data[a][1].length ? this.twoDSeries.push(lt.parseNumber(t[e].data[a][1][3])) : this.twoDSeries.push(lt.parseNumber(t[e].data[a][1])), s.dataFormatXNumeric = !0), "datetime" === i.xaxis.type) {
                ...
                for (var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : this.ctx, i = this.w.config, s = this.w.globals, a = new k(e), n = 0; n < t.length; n++) {
                    ...
                    if ("rangeBar" !== i.chart.type && "rangeArea" !== i.chart.type && "rangeBar" !== t[n].type && "rangeArea" !== t[n].type || (s.isRangeData = !0, this.handleRangeData(t, n)), this.isMultiFormat()) this.isFormat2DArray() ? this.handleFormat2DArray(t, n) : this.isFormatXY() && this.handleFormatXY(t, n), "candlestick" !== i.chart.type && "candlestick" !== t[n].type || this.handleCandleStickData(t, n), s.series.push(this.twoDSeries), s.labels.push(this.twoDSeriesX), s.seriesX.push(this.twoDSeriesX), this.fallbackToCategory || (s.isXNumeric = !0); else {
                        if ("datetime" === i.xaxis.type) {
                            s.isXNumeric = !0;
                            for (var r = 0 < i.labels.length ? i.labels.slice() : i.xaxis.categories.slice(), o = 0; o < r.length; o++) if ("string" == typeof r[o]) {
            ...
            key: "handleExternalLabelsData", value: function (t) {
                ...
                if (0 < e.xaxis.categories.length) i.labels = e.xaxis.categories; else if (0 < e.labels.length) i.labels = e.labels.slice(); else if (this.fallbackToCategory) i.labels = i.labels[0]; else {
                    var s = [];
                    if (i.axisCharts) {
            ...
            key: "xySettings", value: function () {
                var t = null, e = this.w;
                if (e.globals.axisCharts && ("back" === e.config.xaxis.crosshairs.position && new x(this.ctx).drawXCrosshairs(), "back" === e.config.yaxis[0].crosshairs.position && new x(this.ctx).drawYCrosshairs(), t = this.coreUtils.getCalculatedRatios(), "datetime" === e.config.xaxis.type && void 0 === e.config.xaxis.labels.formatter)) {
                    var i, s = new N(this.ctx);
            ...
            key: "drawAxis", value: function (t, e) {
                var i, s, a = this.w.globals, n = this.w.config, r = new F(this.ctx), o = new v(this.ctx);
            ...
            key: "setupBrushHandler", value: function () {
                ...
                a.config.chart.brush.enabled && "function" != typeof a.config.chart.events.selection && (a.config.chart.brush.targets || [a.config.chart.brush.target]).forEach(function (t) {
                    ...
                    "function" != typeof s.w.config.chart.events.zoomed && (s.w.config.chart.events.zoomed = function () {
                        ...
                        a.config.chart.brush.autoScaleYaxis && (i = new X(s).autoScaleY(s, e)), s._updateOptions({
                            xaxis: {
                                min: e.xaxis.min,
                                max: e.xaxis.max
                            }, yaxis: i
    ...
    function V(i, s) {
        ...
        0 !== i._state ? (i._handled = !0, B._immediateFn(function () {
    ...
    function G(t, e) {
        try {
            ...
            if (e && ("object" == typeof e || "function" == typeof e)) {
                ...
                if ("function" == typeof i) return void q((s = i, a = e, function () {
                    s.apply(a, arguments)
                }), t)
            }
    ...
    var Z, $, J = function () {
        ...
        return r(e, [{
            ...
            key: "dataURI", value: function () {
                ...
                return new B(function (e) {
                    ...
                    var o = h.getSvgString(), l = "data:image/svg+xml," + encodeURIComponent(o);
                    r.onload = function () {
        ...
        return r(i, [{
            ...
            key: "drawGrid", value: function () {
                var t = this.w, e = new F(this.ctx), i = new v(this.ctx), s = this.w.globals, a = null;
                if (s.axisCharts) {
            ...
            key: "renderGrid", value: function () {
                ...
                if (t.globals.isBarHorizontal) {
                    ...
                    if (t.config.grid.yaxis.lines.show) for (var f = 0, p = 0, x = t.globals.gridWidth, b = 0; b < t.globals.dataPoints + 1; b++) {
                    ...
                    if (r = this.xaxisLabels.length, t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show) {
                        ...
                        if (0 < t.globals.timelineLabels.length) for (var k = 0; k < r; k++) {
            ...
            key: "drawGridBands", value: function (t, e, i) {
                ...
                if (void 0 !== s.config.grid.row.colors && 0 < s.config.grid.row.colors.length) for (var n = 0, r = s.globals.gridHeight / i, o = s.globals.gridWidth, l = 0, h = 0; l < i; l++, h++) {
                ...
                if (void 0 !== s.config.grid.column.colors && 0 < s.config.grid.column.colors.length) for (var u = s.globals.padHorizontal, g = s.globals.padHorizontal + s.globals.gridWidth / e, f = s.globals.gridHeight, p = 0, x = 0; p < e; p++, x++) {
        ...
        return r(i, [{
            ...
            key: "drawLegends", value: function () {
                ...
                for (var n = t.globals.legendFormatter, r = 0; r <= i.length - 1; r++) {
                    ...
                    var g = t.config.legend.markers.offsetX, f = t.config.legend.markers.offsetY,
                        p = t.config.legend.markers.height, x = t.config.legend.markers.width,
                        b = t.config.legend.markers.strokeWidth, m = t.config.legend.markers.strokeColor,
            ...
            key: "setLegendWrapXY", value: function (t, e) {
                ...
                if ("bottom" === i.config.legend.position) r += i.globals.svgHeight - a.height / 2; else if ("top" === i.config.legend.position) {
                    var o = new D(this.ctx), l = o.getTitleSubtitleCoords("title").height,
            ...
            key: "legendAlignHorizontal", value: function () {
                ...
                var e = this.getLegendBBox(), i = new D(this.ctx), s = i.getTitleSubtitleCoords("title"),
            ...
            key: "onLegendHovered", value: function (t) {
                ...
                if ("heatmap" !== e.config.chart.type) !t.target.classList.contains("inactive-legend") && i && new R(this.ctx).toggleSeriesOnHover(t, t.target); else if (i) {
            ...
            key: "toggleDataSeries", value: function (t, e) {
                ...
                if (i.globals.axisCharts || "radialBar" === i.config.chart.type) {
                    ...
                    if ("pie" === c || "donut" === c) {
                        var d = i.config.plotOptions.pie.donut.labels, u = new ht(this.ctx), g = new T(this.ctx);
            ...
            key: "riseCollapsedSeries", value: function (t, e, i) {
                var s = this.w;
                if (0 < t.length) for (var a = 0; a < t.length; a++) t[a].index === i && (s.globals.axisCharts ? s.config.series[i].data = t[a].data.slice() : s.config.series[i] = t[a].data, t.splice(a, 1), e.splice(a, 1), s.globals.risingSeries.push(i), this.ctx._updateSeries(s.config.series, s.config.chart.animations.dynamicAnimation.enabled))
            }
        }]), i
    }(), tt = function () {
        function e(t) {
                ...
                if (0 !== e.responsive.length) {
                    ...
                    var l = new u({}), i = function () {
                        var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
                            e = o[0].breakpoint, i = 0 < window.innerWidth ? window.innerWidth : screen.width;
                        if (e < i) {
        ...
        return r(e, [{
            ...
            key: "closestInMultiArray", value: function (r, o, l, h) {
                ...
                var i = h[e][0], s = l[e][0], u = Math.abs(r - s), g = Math.abs(o - i), f = g + u;
        ...
        return r(e, [{
            ...
            key: "getValuesToPrint", value: function (t) {
                ...
                var c = n;
                return n = s.globals.isXNumeric && "datetime" === s.config.xaxis.type ? new b(this.ctx).xLabelFormat(s.globals.ttKeyFormatter, c) : s.globals.xLabelFormatter(c, l), void 0 !== s.config.tooltip.x.formatter && (n = s.globals.ttKeyFormatter(c, l)), 0 < s.globals.seriesZ.length && 0 < s.globals.seriesZ[0].length && (r = h(s.globals.seriesZ[e][i], s)), {
                    val: o,
                    xVal: n,
        ...
        return r(e, [{
            key: "moveXCrosshairs", value: function (t) {
                var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : null, i = this.ttCtx,
            ...
            key: "moveYCrosshairs", value: function (t) {
                ...
                null !== e.ycrosshairs && (ht.setAttrs(e.ycrosshairs, {
                    y1: t,
                    y2: t
                }), ht.setAttrs(e.ycrosshairsHidden, {y1: t, y2: t}))
            }
        }, {
            ...
            key: "moveMarkers", value: function (t, e) {
                ...
                if (0 < i.globals.markers.size[t]) for (var a = i.globals.dom.baseEl.querySelectorAll(" .apexcharts-series[data\\:realIndex='".concat(t, "'] .apexcharts-marker")), n = 0; n < a.length; n++) parseInt(a[n].getAttribute("rel")) === e && (s.marker.resetPointsSize(), s.marker.enlargeCurrentPoint(e, a[n])); else s.marker.resetPointsSize(), this.moveDynamicPointOnHover(e, t)
            }
        }, {
        ...
        return r(i, [{
            ...
            key: "seriesHoverByContext", value: function (t) {
                ...
                }, i.e = a, !i.hasBars() || n.globals.comboCharts || i.isBarShared || n.config.tooltip.onDatasetHover.highlightDataSeries && new R(e).toggleSeriesOnHover(a, a.target.parentNode), i.fixedTooltip && i.drawFixedTooltipRect(), n.globals.axisCharts ? i.axisChartsTooltips({
                    e: a,
                    opt: s,
            ...
            key: "create", value: function (t, e, i, s, a) {
                var n = 5 < arguments.length && void 0 !== arguments[5] ? arguments[5] : null, r = this.w, o = e;
        ...
        return a(i, xt), r(i, [{
            ...
            key: "selectionDrawing", value: function (t) {
                var e, i = t.context, s = t.zoomtype, a = this.w, n = i, r = this.gridRect.getBoundingClientRect(),
                    o = n.startX - 1, l = n.startY, h = n.clientX - r.left - o, c = n.clientY - r.top - l, d = 0, u = 0;
            ...
            key: "selectionDragging", value: function (t, e) {
                var r = this, o = this.w, l = this.xyRatios, h = this.selectionRect, i = 0;
                "resizing" === t && (i = 30), "function" == typeof o.config.chart.events.selection && o.globals.selectionEnabled && (clearTimeout(this.w.globals.selectionResizeTimer), this.w.globals.selectionResizeTimer = window.setTimeout(function () {
                    var t = r.gridRect.getBoundingClientRect(), e = h.node.getBoundingClientRect(),
            ...
            key: "selectionDrawn", value: function (t) {
                ...
                var h = s.globals.xAxisScale.niceMin + a.startX * n.xRatio,
                    c = s.globals.xAxisScale.niceMin + a.endX * n.xRatio, d = [], u = [];
                ...
                }), a.dragged && (10 < a.dragX || 10 < a.dragY) && h !== c) if (s.globals.zoomEnabled) {
            ...
            key: "panScrolled", value: function (t, e, i) {
                ...
                var r = {min: e, max: i};
                s.config.chart.zoom.autoScaleYaxis && (n = new X(me.ctx).autoScaleY(me.ctx, {xaxis: r})), this.ctx._updateOptions({
                    xaxis: {
                        min: e,
                        max: i
                    }, yaxis: n
    ...
    return Z = "undefined" != typeof window ? window : void 0, $ = function (r, a) {
        ...
        }, d.parser = {native: d.create("svg")}, a.addEventListener("DOMContentLoaded", function () {
        ...
        for (var l = {
            ...
            return function (t, e, i) {
                if ("H" == n) t[0] = t[0] + e.x; else if ("V" == n) t[0] = t[0] + e.y; else if ("A" == n) t[5] = t[5] + e.x, t[6] = t[6] + e.y; else for (var s = 0, a = t.length; s < a; ++s) t[s] = t[s] + (s % 2 ? e.y : e.x);
                return l[n](t, e, i)
            }
        }(t[e].toUpperCase());
        d.PathArray = function (t, e) {
            ...
            toString: function () {
                ...
                var i = this.bbox();
                if (t -= i.x, e -= i.y, !isNaN(t) && !isNaN(e)) for (var s, a = this.value.length - 1; 0 <= a; a--) "M" == (s = this.value[a][0]) || "L" == s || "T" == s ? (this.value[a][1] += t, this.value[a][2] += e) : "H" == s ? this.value[a][1] += t : "V" == s ? this.value[a][1] += e : "C" == s || "S" == s || "Q" == s ? (this.value[a][1] += t, this.value[a][2] += e, this.value[a][3] += t, this.value[a][4] += e, "C" == s && (this.value[a][5] += t, this.value[a][6] += e)) : "A" == s && (this.value[a][6] += t, this.value[a][7] += e);
                return this
            }, size: function (t, e) {
                var i, s, a = this.bbox();
                ...
                if (!this.destination) return this;
                var e, i, s, a, n = this.value, r = this.destination.value, o = [], l = new d.PathArray;
            ...
            create: function (t) {
                ...
                animate: function (t, e, i) {
                    ...
                    for (t in s.animations) for (i = this.target()[t](), Array.isArray(i) || (i = [i]), Array.isArray(s.animations[t]) || (s.animations[t] = [s.animations[t]]), e = i.length; e--;) s.animations[t][e] instanceof d.Number && (i[e] = new d.Number(i[e])), s.animations[t][e] = i[e].morph(s.animations[t][e]);
                    ...
                    if (n.transforms.length) {
                        for (i = n.initialTransformation, t = 0, e = n.transforms.length; t < e; t++) {
                            ...
                            r instanceof d.Matrix ? i = r.relative ? i.multiply((new d.Matrix).morph(r).at(n.ease(this.pos))) : i.morph(r).at(n.ease(this.pos)) : (r.relative || r.undo(i.extract()), i = i.multiply(r.at(n.ease(this.pos))))
                        }
                        a.matrix(i)
                    }
                    return this
            ...
            attr: function (t, e, i) {
                if ("object" === w(t)) for (var s in t) this.attr(s, t[s]); else this.add(t, e, "attrs");
                return this
            }, style: function (t, e) {
                if ("object" === w(t)) for (var i in t) this.style(i, t[i]); else this.add(t, e, "styles");
                return this
            }, x: function (t, e) {
            ...
            create: function (t) {
                ...
                extract: function () {
                    var t = g(this, 0, 1), e = g(this, 1, 0), i = 180 / Math.PI * Math.atan2(t.y, t.x) - 90;
                    return {
                        x: this.e,
                        y: this.f,
            ...
            create: function (t, e) {
                var i;
                i = Array.isArray(t) ? {x: t[0], y: t[1]} : "object" === w(t) ? {x: t.x, y: t.y} : null != t ? {
                    x: t,
                    y: null != e ? e : t
            ...
            attr: function (t, e, i) {
                ...
                if ("object" === w(t)) for (e in t) this.attr(e, t[e]); else if (null === e) this.node.removeAttribute(t); else {
            ...
            transform: function (t, e) {
                ...
                if (i = new d.Matrix(this), e = !!e || !!t.relative, null != t.a) i = e ? i.multiply(new d.Matrix(t)) : new d.Matrix(t); else if (null != t.rotation) p(t, this), i = e ? i.rotate(t.rotation, t.cx, t.cy) : i.rotate(t.rotation - i.extract().rotation, t.cx, t.cy); else if (null != t.scale || null != t.scaleX || null != t.scaleY) {
            ...
            create: function (t, e) {
                ...
                if (Array.isArray(t)) for (var i = 0, s = this.arguments.length; i < s; ++i) this[this.arguments[i]] = t[i]; else if ("object" === w(t)) for (i = 0, s = this.arguments.length; i < s; ++i) this[this.arguments[i]] = t[this.arguments[i]];
            ...
            style: function (t, e) {
                ...
                if (arguments.length < 2) if ("object" === w(t)) for (e in t) this.style(e, t[e]); else {
            ...
            create: function (t) {
                var e, i, s, a, n, r, o, l = 1, h = 1, c = /[+-]?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?/gi;
                if (t instanceof d.Element) {
                    for (n = ((o = r = t).attr("viewBox") || "").match(c), t.bbox, s = new d.Number(t.width()), a = new d.Number(t.height()); "%" == s.unit;) l *= s.value, s = new d.Number(r instanceof d.Doc ? r.parent().offsetWidth : r.parent().width()), r = r.parent();
            ...
            var n = i.bind(s || t.instance || t), r = (d.handlerMap.indexOf(t) + 1 || d.handlerMap.push(t)) - 1,
            ...
            var s = d.handlerMap.indexOf(t), a = e && e.split(".")[0], n = e && e.split(".")[1], r = "";
            if (-1 != s) if (i) {
            ...
            } else if (n) for (e in d.listeners[s]) for (r in d.listeners[s][e]) n === r && d.off(t, [e, n].join(".")); else if (a) {
                if (d.listeners[s][a]) {
        ...
        }), d.Defs = d.invent({create: "defs", inherit: d.Container}), d.G = d.invent({
            create: "g",
            inherit: d.Container,
            extend: {
                x: function (t) {
            ...
            create: "symbol", inherit: d.Container, construct: {
                symbol: function () {
            ...
            create: "ellipse", inherit: d.Shape, construct: {
            ...
            create: "line", inherit: d.Shape, extend: {
                array: function () {
                    return new d.PointArray([[this.attr("x1"), this.attr("y1")], [this.attr("x2"), this.attr("y2")]])
                }, plot: function (t, e, i, s) {
            ...
            create: "polyline", inherit: d.Shape, construct: {
                polyline: function (t) {
                    return this.put(new d.Polyline).plot(t || new d.PointArray)
                }
            }
        }), d.Polygon = d.invent({
            create: "polygon", inherit: d.Shape, construct: {
                polygon: function (t) {
            ...
            create: "path", inherit: d.Shape, extend: {
            ...
            create: function () {
                ...
                x: function (t) {
                    ...
                    if ("boolean" == typeof t && (this._rebuild = t), this._rebuild) {
                        var e = this, i = 0, s = this.dom.leading * new d.Number(this.attr("font-size"));
            ...
            plain: function (t) {
                ...
                var e = (this.textPath && this.textPath() || this).node, i = new d.Tspan;
        ...
        ["fill", "stroke"].forEach(function (e) {
            ...
            t[e] = function (t) {
                ...
                if ("string" == typeof t || d.Color.isRgb(t) || t && "function" == typeof t.fill) this.attr(e, t); else for (i = s[e].length - 1; 0 <= i; i--) null != t[s[e][i]] && this.attr(s.prefix(e, s[e][i]), t[s[e][i]]);
                return this
            ...
            data: function (e, t, i) {
                if ("object" === w(e)) for (t in e) this.data(t, e[t]); else if (arguments.length < 2) try {
            ...
            remember: function (t, e) {
                if ("object" === w(t)) for (var e in t) this.remember(e, t[e]); else {
        ...
        return $(Z, Z.document)
    }) : "object" === ("undefined" == typeof exports ? "undefined" : w(exports)) && "undefined" != typeof module ? module.exports = Z.document ? $(Z, Z.document) : function (t) {
        return $(t, t.document)
    } : Z.SVG = $(Z, Z.document), function () {
        ...
        var e, n,
            t = (e = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function (t) {
        ...
        return r(i, [{
            ...
            key: "mount", value: function () {
                var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null, n = this, r = n.w;
                return new B(function (t, e) {
                    if (null === n.el) return e(new Error("Not enough data to display or target element not found"));
                    if ((null === a || r.globals.allSeriesCollapsed) && n.series.handleNoData(), n.core.drawAxis(r.config.chart.type, a.xyRatios), n.grid = new Q(n), "back" === r.config.grid.position && n.grid.drawGrid(), "back" === r.config.annotations.position && n.annotations.drawAnnotations(), a.elGraph instanceof Array) for (var i = 0; i < a.elGraph.length; i++) r.globals.dom.elGraphical.add(a.elGraph[i]); else r.globals.dom.elGraphical.add(a.elGraph);
                    if ("front" === r.config.grid.position && n.grid.drawGrid(), "front" === r.config.xaxis.crosshairs.position && n.crosshairs.drawXCrosshairs(), "front" === r.config.yaxis[0].crosshairs.position && n.crosshairs.drawYCrosshairs(), "front" === r.config.annotations.position && n.annotations.drawAnnotations(), !r.globals.noData) {
                        if (r.config.tooltip.enabled && !r.globals.noData && n.w.globals.tooltip.drawTooltip(a.xyRatios), r.globals.axisCharts && r.globals.isXNumeric) (r.config.chart.zoom.enabled || r.config.chart.selection && r.config.chart.selection.enabled || r.config.chart.pan && r.config.chart.pan.enabled) && n.zoomPanSelection.init({xyRatios: a.xyRatios}); else {
            ...
            key: "updateOptions", value: function (t) {
                var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                    ...
                    s = !(3 < arguments.length && void 0 !== arguments[3]) || arguments[3], a = this.w;
            ...
            key: "_updateSeries", value: function (t, e) {
                var i, s = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], a = this.w;
            ...
            key: "setupEventHandlers", value: function () {
                var e = this.w, i = this, s = e.globals.dom.baseEl.querySelector(e.globals.chartClass),
            ...
            key: "addXaxisAnnotation", value: function (t) {
                var e = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1],
                    i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : void 0, s = this;
            ...
            key: "clearAnnotations", value: function () {
                var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : void 0, e = this;
