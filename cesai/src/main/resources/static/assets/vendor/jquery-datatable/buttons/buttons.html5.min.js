(function (j) {
    ...
    if ("undefined" === typeof h || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) r =
        void 0; else {
        var v = h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"), K = "download" in v,
            L = /constructor/i.test(h.HTMLElement) || h.safari, A = /CriOS\/[\d]+/.test(navigator.userAgent),
            M = function (a) {
    ...
    m.ext.buttons.copyHtml5 = {
        className: "buttons-copy buttons-html5", text: function (a) {
            ...
            this.processing(!0);
            var e = this, a = G(c, b), f = c.buttons.exportInfo(b), g = F(b), n = a.str,
